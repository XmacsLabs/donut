...
enum tree_label : int {
  ...
  DD_LENGTH,
  PC_LENGTH,
  CC_LENGTH, // standard absolute units
  FS_LENGTH,
  FBS_LENGTH,
  EM_LENGTH,
  LN_LENGTH,
  ...
  FNTOP_LENGTH,
  SPC_LENGTH,
  XSPC_LENGTH, // font specific & stretchy
  PAR_LENGTH,
  PAW_LENGTH,
  PAG_LENGTH, // page dimensions
  GW_LENGTH,
  GH_LENGTH,
  GU_LENGTH, // extents & unit of graphics
  TMPT_LENGTH,
  PX_LENGTH,
  GUIPX_LENGTH, // miscellaneous
  LCORNER_LENGTH,
  BCORNER_LENGTH,
  RCORNER_LENGTH,
  TCORNER_LENGTH,
